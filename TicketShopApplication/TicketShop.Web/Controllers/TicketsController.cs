...
namespace TicketShop.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        //public async Task<IActionResult> AddTicketToCart([Bind("TicketId", "Quantity")] AddTicketToCartDto item)
        public IActionResult AddTicketToCart(AddTicketToCartDto item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,MovieName,MoviePoster,MovieDescription,Genre,Price,Rating,Date")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,MovieName,MoviePoster,MovieDescription,Genre,Price,Rating,Date")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
